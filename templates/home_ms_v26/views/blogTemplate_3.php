<?php ob_start(); ?>
<section class="u-clearfix u-section-4" id="sec-c981">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php if ($image0) : ?><a class="u-blog-control u-expanded-width u-image u-image-default u-image-1" href="<?php $link = $titleLink0 ? $titleLink0 : $readmoreLink0; if($link): echo $link; endif; ?>"><img src="<?php echo $image0; ?>" alt="" class="u-blog-control u-expanded-width u-image u-image-default u-image-1" data-image-width="1080" data-image-height="1080"></a><?php else: ?><div class="hidden-image"></div><?php endif; ?>
...
</section><?php if (!($image0)) : ?><style>.u-section-4 .u-sheet { min-height: auto; }</style><?php endif; ?>
