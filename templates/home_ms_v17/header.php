...
<input type="hidden" name="option" value="com_search">
              ...
              <div class="u-container-layout u-container-layout-3">
                <div class="u-container-style u-group u-shape-rectangle u-group-2">
                  <div class="u-container-layout u-container-layout-4">
                    <a href="index.php/ms/soalan-lazim" class="u-btn u-button-style u-none u-btn-1"><img src="<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/faq.png" alt="" class="u-image u-image-default u-preserve-proportions u-image-2" data-image-width="74" data-image-height="64" data-href="#">Soalan Lazim</a>
                  </div>
                </div>
                <div class="u-container-style u-group u-shape-rectangle u-group-3">
                  <div class="u-container-layout u-container-layout-5">
                    <a href="index.php/ms/hubungi-kami" class="u-btn u-button-style u-none u-btn-2"><img src="<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/hubungi.png" alt="" class="u-image u-image-default u-preserve-proportions u-image-3" data-image-width="58" data-image-height="52" data-href="#">Hubungi Kami</a>
                  </div>
                </div>
                <div class="u-container-style u-group u-shape-rectangle u-group-4">
                  <div class="u-container-layout u-container-layout-6">
                    <a href="https://kpwkm.spab.gov.my/eApps/system/index.do" class="u-btn u-button-style u-none u-btn-3" target="_blank"><img src="<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/maklumbalas.png" alt="" class="u-image u-image-default u-preserve-proportions u-image-4" data-image-width="74" data-image-height="63" data-href="#">Aduan &amp;<br>Maklumbalas 
                    </a>
                  </div>
                </div>
                <div class="u-container-style u-group u-shape-rectangle u-group-5">
                  <div class="u-container-layout u-valign-top u-container-layout-7">
                    <a href="#" class="u-btn u-button-style u-none u-btn-4"><img src="<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/peta.png" alt="" class="u-image u-image-default u-preserve-proportions u-image-5" data-image-width="70" data-image-height="63" data-href="#">Peta Laman</a>
                  </div>
                </div>
              </div>
            </div>
  ...
  <div class="u-black u-container-style u-expanded-width u-group u-shape-rectangle u-group-6">
    <div class="u-container-layout u-valign-top-xs u-container-layout-8"></div>
  </div>
