...
class CorePage
{
    ...
    public function renderLayout()
    {
        ...
        if (!$this->isFrontEditing()) {
            ...
            $content = $this->fixVmScripts($content);
        ...
        switch ($option) {
            ...
            case "com_virtuemart":
                switch ($view) {
                    case "productdetails":
                        $this->renderLayoutByType('product');
                        return;
                    case "category":
                        $this->renderLayoutByType('products');
                        return;
                    case "cart":
                        $this->renderLayoutByType('cart');
                        return;
                }
    ...
    public function renderLayoutByType($type) {
