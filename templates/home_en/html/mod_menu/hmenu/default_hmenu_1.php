...
?>
	<nav class="u-align-left u-menu u-menu-dropdown u-offcanvas u-menu-1">
            <div class="menu-collapse u-custom-font u-font-oswald" style="font-weight: 700;">
              <a class="u-black u-button-style u-nav-link u-text-active-palette-3-base u-text-hover-palette-3-base u-text-white" href="#" style="padding: 4px 30px; font-size: calc(1em + 8px);">
...
$menu_html = buildMenu($list, $default_id, $active_id, $path, array(
		...
		'link_class' => 'u-black u-button-style u-nav-link u-text-active-palette-3-base u-text-hover-palette-3-base u-text-white',
        'link_style' => 'padding: 14px 26px;',
		'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-7e08-51',
...
$resp_menu = buildMenu($list, $default_id, $active_id, $path, array(
        ...
        'link_style' => 'padding: 18px 26px;',
		'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-7e08-52',
		'submenu_item_class' => 'u-nav-item',
