    ...
    function block_1($caption, $content) {
            ...
            <div class="u-block">
                <div class="u-block-container u-clearfix"><!--block_header-->
                  <?php if ($hasCaption) : ?><h5 class="u-block-header u-text u-text-9"><?php echo $caption; ?></h5><?php endif; ?><!--/block_header--><!--block_content-->
                  <?php if ($hasContent) : ?><div class="u-block-content u-text u-text-10"><?php echo $content; ?></div><?php endif; ?><!--/block_content-->
                </div>
              </div>
            <?php
            return ob_get_clean();
