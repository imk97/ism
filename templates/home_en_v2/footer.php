...
?>
    <footer class="u-align-left u-clearfix u-footer u-white u-footer" id="sec-ba58">
  ...
  <div class="u-clearfix u-layout-wrap u-layout-wrap-1">
      ...
      <div class="u-layout-row">
        ...
        <div class="u-container-style u-layout-cell u-size-15-sm u-size-15-xl u-size-15-xs u-size-16-lg u-size-34-md u-layout-cell-2">
          <div class="u-container-layout u-valign-bottom-md u-container-layout-2">
            ...
            <p class="u-text u-text-3">Tel: 03-79853333 Fax: 03-79853300 Email: info@ism.gov.my</p>
          </div>
        </div>
        <div class="u-container-style u-layout-cell u-size-15-sm u-size-15-xl u-size-15-xs u-size-17-lg u-size-26-md u-layout-cell-3">
          <div class="u-container-layout u-valign-top-md u-container-layout-3">
            <p class="u-custom-font u-font-arial u-text u-text-default u-text-palette-1-base u-text-4">Site Map</p>
            <p class="u-custom-font u-font-arial u-text u-text-palette-1-base u-text-5">Disclaimer</p>
            <p class="u-custom-font u-font-arial u-text u-text-default u-text-6">|</p>
            <p class="u-custom-font u-font-arial u-text u-text-7">|</p>
            <p class="u-custom-font u-font-arial u-text u-text-default u-text-palette-1-base u-text-8">Contact Us</p>
            <p class="u-custom-font u-font-arial u-text u-text-9">|</p>
            <p class="u-custom-font u-font-arial u-text u-text-default u-text-palette-1-base u-text-10">Help</p><!--position-->
            <?php $positionName = 'statistic'; if ($positionName && CoreStatements::containsModules($positionName)) : ?><div data-position="statistic" class="u-expanded-width-md u-position u-position-1"><!--block-->
              <?php echo CoreStatements::position('statistic', 'block%block_2', 'block_2'); ?><!--/block-->
    ...
    echo "Sample PHP";
?></div>
            <p class="u-custom-font u-font-arial u-text u-text-palette-1-base u-text-13">Privacy Policy</p>
            <p class="u-custom-font u-font-arial u-text u-text-default u-text-14">|</p>
            <p class="u-custom-font u-font-arial u-text u-text-palette-1-base u-text-15">Safety Policy</p>
          </div>
        </div>
