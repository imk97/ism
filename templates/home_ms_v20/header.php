          ...
          <div class="u-container-layout u-valign-top-md u-valign-top-sm u-valign-top-xs u-container-layout-3">
            <div class="u-align-center-sm u-align-center-xs u-container-style u-group u-group-2">
              <div class="u-container-layout u-container-layout-4">
                ...
                <div alt="" class="u-image u-image-circle u-preserve-proportions u-image-6" data-image-width="40" data-image-height="40" style="background-image: url('<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/TEXT.jpg');" id="inc"></div>
                <div alt="" class="u-image u-image-circle u-preserve-proportions u-image-7" data-image-width="40" data-image-height="40" style="background-image: url('<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/TEXT1.jpg');" id="default"></div>
                <div alt="" class="u-image u-image-circle u-preserve-proportions u-image-8" data-image-width="40" data-image-height="40" style="background-image: url('<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/TEXT-.jpg');" id="dec"></div>
