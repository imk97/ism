...
$metaGeneratorContent = 'Nicepage 3.2.5, nicepage.com';
...
$(document).ready( function() {
    ...
    $('#blue').click( function () {
      ...
      $('.u-header, .u-footer').css('background-image', 'linear-gradient(to right, white, #39B0EB)')
    })
    ...
    $('#grey').click( function () {
      ...
      $('.u-header, .u-footer').css('background-image', 'linear-gradient(to right, white, #d1d8d8)')
    })
    ...
    $('#mintgreen').click( function () {
      ...
      $('.u-header, .u-footer').css('background-image', 'linear-gradient(to right, white, #98ff98)')
    })
