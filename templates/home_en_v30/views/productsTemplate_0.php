<!--product_item-->
      <div class="u-align-center u-container-style u-products-item product u-repeater-item u-white u-repeater-item-1">
        <div class="u-container-layout u-similar-container u-valign-top u-container-layout-1"><!--product_image-->
          <?php if ($image0) : ?><a class="u-expanded-width u-image u-image-default u-product-control u-image-1" href="<?php $link = $titleLink0 ? $titleLink0 : ''; if($link): echo $link; endif; ?>"><img alt="" class="u-expanded-width u-image u-image-default u-product-control u-image-1" src="<?php echo $image0; ?>"></a><?php else: ?><div class="hidden-image"></div><?php endif; ?><!--/product_image--><!--product_title-->
