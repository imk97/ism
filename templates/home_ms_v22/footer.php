...
?>
  ...
  <div class="u-custom-color-1 u-expanded-width u-shape u-shape-rectangle u-shape-1 footer-change"></div>
  <div class="u-black u-expanded-width u-shape u-shape-rectangle u-shape-2"></div>
  <div class="u-clearfix u-layout-wrap u-layout-wrap-1">
    <div class="u-gutter-0 u-layout">
      <div class="u-layout-row">
        <div class="u-align-left u-container-style u-layout-cell u-size-26-md u-size-26-sm u-size-26-xs u-size-29-lg u-size-30-xl u-layout-cell-1">
          <div class="u-container-layout u-container-layout-1">
            <img src="<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/logo-ism-removebg-preview.png" alt="logo ism" class="u-align-center-sm u-align-center-xs u-image u-image-default u-image-1" data-image-width="594" data-image-height="420">
            <h4 class="u-custom-font u-font-oswald u-text u-text-1">INSTITUT SOSIAL MALAYSIA </h4>
            <p class="custom-footer u-custom-font u-font-arial u-text u-text-2">Lot PT 138556 KM 6 <br>Lebuhraya Kuala Lumpur - Seremban,<br>57100 Sungai Besi, Kuala Lumpur, Malaysia 
            </p>
            <p class="custom-footer u-custom-font u-font-arial u-text u-text-3">Tel: 03-79853333 </p>
            <p class="custom-footer u-custom-font u-font-arial u-text u-text-4">Faks: 03-79853300 </p>
            <p class="custom-footer u-custom-font u-font-arial u-text u-text-5">Emel: info@ism.gov.my </p>
            <div class="custom-footer u-clearfix u-custom-html u-custom-html-1">
              <div class="container">
                <span>
                  <p style="font-size: 12px;">
                    <a href="https://ul.waze.com/ul?place=ChIJNb3d4ntKzDERT5uiZcHC8SY&ll=3.07833900%2C101.70122530&navigate=yes&utm_campaign=iframe+module&utm_source=waze_website&utm_medium=lm_share_location" target="_blank">Waze</a> | <a href="https://www.google.com.my/maps/place/Institut+Sosial+Malaysia/@3.0768594,101.6997953,17z/data=!3m1!4b1!4m2!3m1!1s0x31cc4a7959c4d5f3:0xf19d482899add6e?hl=en&shorturl=1" target="_blank">Google Maps</a>
                  </p>
                </span>
              </div>
            </div>
        ...
        <div class="u-container-style u-layout-cell u-size-30-xl u-size-31-lg u-size-34-md u-size-34-sm u-size-34-xs u-layout-cell-2">
          <div class="u-container-layout u-container-layout-2"><!--position-->
            <?php $positionName = 'statistic'; if ($positionName && CoreStatements::containsModules($positionName)) : ?><div data-position="statistic" class="u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-position u-position-1"><!--block-->
              <?php echo CoreStatements::position('statistic', 'block%block_1', 'block_1'); ?><!--/block-->
            ...
            <div class="u-custom-php u-expanded-width-md u-custom-php-1"><?php
$server = "localhost";
$username = "root";
$password = "";
$db = "ism";
...
try {
    ...
    $date = date('Y-m-d');
    $query = $connection->query("SELECT count(*) FROM gr8os_visitor WHERE ipaddress = '$ipadd' AND date = '$date' ");
...
?></div>
            <div class="custom-footer u-clearfix u-custom-html u-custom-html-2">
              <div class="container">
                <span>
                  <p style="font-size: 12px;">
                    <a href="/ism/index.php/ms/peta-laman">Peta Laman</a> | <a href="/ism/index.php/ms/penafian">Penafian</a> | <a href="/ism/index.php/ms/dasar-privasi">Dasar Privasi</a> | <a href="/ism/index.php/ms/dasar-keselamatan">Dasar Keselamatan</a> | <a href="/ism/index.php/ms/hubungi-kami">Hubungi Kami</a>
                  </p>
                </span>
              </div>
            </div>
      ...
      <div class="u-layout-row">
        <div class="u-black u-container-style u-layout-cell u-size-60 u-layout-cell-3">
          <div class="u-container-layout u-valign-middle u-container-layout-3">
            <p class="u-text u-text-default u-text-8">Hak Cipta © 2021 Institut Sosial Malaysia. Hak Cipta Terpelihara.</p>
          </div>
        </div>
      </div>
    </div>
