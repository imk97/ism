...
.u-footer .u-text-1 {
  ...
  font-size: 1.5rem;
  font-style: normal;
  margin: -159px 55px 0 247px;
}
.u-footer .u-text-2 {
  font-size: 0.75rem;
  margin: 9px 74px 0 247px;
}
.u-footer .u-custom-html-1 {
  min-height: 59px;
  height: auto;
  margin: -20px 180px 0 247px;
}
