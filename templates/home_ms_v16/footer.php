...
?></div>
            ...
            <p class="u-custom-font u-font-arial u-text u-text-palette-1-base u-text-17">Dasar Keselamatan</p>
            <p class="u-custom-font u-font-arial u-text u-text-palette-1-base u-text-18">Dasar Privasi</p>
            <p class="u-text u-text-19">|</p>
            <p class="u-custom-font u-font-arial u-text u-text-palette-1-base u-text-20">Hubungi Kami</p>
            <p class="u-text u-text-default u-text-21">|</p>
          </div>
        </div>
      </div>
    </div>
  </div>
  <p class="u-custom-font u-font-arial u-text u-text-palette-1-base u-text-22">Bantuan</p>
