          ...
          <div class="u-container-layout u-valign-top-sm u-valign-top-xs u-container-layout-3">
            <div class="u-container-style u-group u-group-2">
              <div class="u-container-layout u-container-layout-4">
                ...
                <div alt="" class="u-image u-image-circle u-preserve-proportions u-image-5" data-image-width="40" data-image-height="40" style="background-image: url('<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/TEXT1.jpg');" id="default"></div>
                <div alt="" class="u-image u-image-circle u-preserve-proportions u-image-6" data-image-width="40" data-image-height="40" style="background-image: url('<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/TEXT-.jpg');" id="dec"></div>
              ...
              <div class="u-container-layout u-container-layout-5">
                <div class="u-container-style u-group u-shape-rectangle u-group-4">
                  <div class="u-container-layout u-container-layout-6">
                    <a href="/ism/index.php/ms/korporat/soalan-lazim" class="u-btn u-button-style u-none u-btn-1"><img src="<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/faq.png" alt="" class="u-image u-image-default u-preserve-proportions u-image-9" data-image-width="74" data-image-height="64">Soalan Lazim</a>
                  </div>
                </div>
                <div class="u-container-style u-group u-shape-rectangle u-group-5">
                  <div class="u-container-layout u-container-layout-7">
                    <a href="/ism/index.php/ms/hubungi-kami" class="u-btn u-button-style u-none u-btn-2"><img src="<?php $app = JFactory::getApplication();  echo JURI::root(true); ?>/templates/<?php echo $app->getTemplate(); ?>/images/hubungi.png" alt="" class="u-image u-image-default u-preserve-proportions u-image-10" data-image-width="58" data-image-height="52">Hubungi Kami</a>
                  </div>
                </div>
