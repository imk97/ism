function openEditLinkDialog(data) {
    ...
    (function($) {
        ...
        SqueezeBox.fromElement(window.phpVars.editLinkUrl + '&u=' + Date.now(), {
            ...
            onUpdate : function (container) {
                if (container.firstChild) {
                    ...
                    $('.anchors-list, .files-list, .dialogs-list', ifrDoc).on('click', handleListItemClick);
        ...
        function setDialogOptions(ifrDoc, data) {
            ...
            $('#files-list, #dialogs-list', ifrDoc).empty();
            ...
            if (data.isMenu) {
                $('#file-link, #dialog-link', ifrDoc).parent().addClass('hidden');
            }
