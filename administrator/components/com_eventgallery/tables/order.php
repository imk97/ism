...
class EventgalleryTableOrder extends JTable
{
    ...
    protected function onAfterStore()
    {
        ...
        if ($order->getPaymentMethod() != null
            ...
            {
                $result = $this->_sendMail('paid_order', $order, $config->getCheckout()->doShowVat());
            }
        ...
        if ($order->getShippingMethod() != null
            ...
            $result = $this->_sendMail('shipped_order', $order, $config->getCheckout()->doShowVat());
        }
     ...
     * @return mixed|string
     */
    private function _sendMail($mailtype, $order, $show_vat) {
