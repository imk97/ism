...
?>
<div data-action="<?php echo JRoute::_('index.php?format=raw&option=com_eventgallery&layout=edit&id='. $order->getId()); ?>" method="POST" name="modalordereditform" id="modalordereditform">
