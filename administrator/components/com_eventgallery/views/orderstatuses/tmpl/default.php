                ...
                <tr>
                    ...
                    <th class="nowrap" width="1%">
                     ...
                     <th width="1%">
                        ...
                        <?php echo (new JLayoutFile('eventgallery.orderingsave'))->render(['task'=>'orderstatuses.saveorder']); ?>
                    </th>
                    <th>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <?php ELSE:?>
                                <a title="<?php echo JText::_('COM_EVENTGALLERY_BUTTON_NOTDEFAULT_DESC'); ?>" href="#" onclick="return Joomla.listItemTask('cb<?php echo $i; ?>','orderstatuses.default')" class="btn btn-micro"><i class="icon-star-empty"></i></a>
                            <?php ENDIF ?>
                    ...
                    <td class="order nowrap">
                        <?php echo (new JLayoutFile('eventgallery.orderingcontrolls'))->render(['currentIndex' => $i, 'numberOfItems'=>$n, 'value'=>$item->getOrdering(), 'pagination'=>$this->pagination, 'taskPrefix'=>'orderstatuses']); ?>
                    </td>
                    <td>
