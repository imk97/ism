            ...
            <thead>
                <tr>
                    ...
                    <th width="1%">
                        ...
                        <?php echo (new JLayoutFile('eventgallery.orderingsave'))->render(['task'=>'surcharges.saveorder']); ?>
                    </th>
                    <th>
            ...
            ?>
                ...
                <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <div class="btn-group">
                            <?php IF ($item->isPublished()): ?>
                                <a title="<?php echo JText::_('COM_EVENTGALLERY_BUTTON_PUBLISHED_DESC'); ?>" style="color: green" class="btn btn-micro active jgrid" href="javascript:void(0);"
                                    onclick="return Joomla.listItemTask('cb<?php echo $i;?>','surcharges.unpublish')">
                            ...
                            <?php ELSE:?>
                                <a title="<?php echo JText::_('COM_EVENTGALLERY_BUTTON_UNPUBLISHED_DESC'); ?>" style="color: red" class="btn btn-micro jgrid" href="javascript:void(0);"
                                    onclick="return Joomla.listItemTask('cb<?php echo $i;?>','surcharges.publish')">
                            ...
                            <?php ELSE:?>
                                <a title="<?php echo JText::_('COM_EVENTGALLERY_BUTTON_NOTDEFAULT_DESC'); ?>" href="#" onclick="return Joomla.listItemTask('cb<?php echo $i; ?>','surcharges.default')" class="btn btn-micro"><i class="icon-star-empty"></i></a>
                            <?php ENDIF ?>
                    ...
                    <td class="order nowrap">
                        <?php echo (new JLayoutFile('eventgallery.orderingcontrolls'))->render(['currentIndex' => $i, 'numberOfItems'=>$n, 'value'=>$item->getOrdering(), 'pagination'=>$this->pagination, 'taskPrefix'=>'surcharges']); ?>
                    </td>
                    <td>
